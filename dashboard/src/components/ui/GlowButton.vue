<template>
  <button
    ...
    @mousemove="onMove"
    @mouseleave="onLeave"
    class="glow-btn relative overflow-hidden rounded bg-emerald-600 py-2 font-medium text-white transition-colors duration-200 hover:bg-emerald-700 disabled:opacity-50"
    :class="className"
  >
    ...
    <span
      ...
      :class="{
        'opacity-100': !!hoverGlow && !(disabled || loading),
        'opacity-0': !hoverGlow || disabled || loading,
      }"
      :style="hoverGlow || {}"
    ></span>
