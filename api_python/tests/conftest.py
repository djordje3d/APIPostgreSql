...
# config treat auth as disabled; test_auth.py patches api_python.app.auth.API_KEY when it needs auth on.
os.environ["API_KEY"] = ""
...
from api_python.app.main import app
from api_python.app.db import get_db, engine
